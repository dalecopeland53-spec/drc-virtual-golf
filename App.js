...
const liveProjectUrl='https://dalecopeland53-spec.github.io/drc-virtual-golf/?build=20260909b6';
...
const injected=`(function(){if(window.__DRC_NATIVE_BRIDGE_B6__)return;window.__DRC_NATIVE_BRIDGE_B6__=true;function nativeSpeak(text){try{window.ReactNativeWebView.postMessage(JSON.stringify({type:'DRC_SPEAK',text:String(text||'')}));}catch(e){}}window.speak=nativeSpeak;window.speakAnswer=nativeSpeak;})();true;`;
return <SafeAreaView style={[styles.safe,Platform.OS==='android'&&styles.androidSafe]}><StatusBar barStyle="light-content" backgroundColor="#020812"/><WebView ref={webRef} source={{uri:liveProjectUrl}} style={styles.web} originWhitelist={['*']} javaScriptEnabled domStorageEnabled geolocationEnabled allowsInlineMediaPlayback mediaPlaybackRequiresUserAction={false} mixedContentMode="always" cacheEnabled={false} incognito={false} injectedJavaScript={injected} onMessage={handleWebMessage}/></SafeAreaView>;
}
const styles=StyleSheet.create({safe:{flex:1,backgroundColor:'#020812'},androidSafe:{paddingBottom:24},web:{flex:1,backgroundColor:'#020812'}});