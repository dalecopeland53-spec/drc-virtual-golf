...
const liveProjectUrl='https://dalecopeland53-spec.github.io/drc-virtual-golf/?build=20260909b5';
...
const injected=`(function(){if(window.__DRC_NATIVE_BRIDGE_B5__)return;window.__DRC_NATIVE_BRIDGE_B5__=true;function nativeSpeak(text){try{window.ReactNativeWebView.postMessage(JSON.stringify({type:'DRC_SPEAK',text:String(text||'')}));}catch(e){}}window.speak=nativeSpeak;window.speakAnswer=nativeSpeak;})();true;`;
